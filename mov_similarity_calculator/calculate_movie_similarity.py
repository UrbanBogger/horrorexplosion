...
def get_similar_movies_2(movie, all_movies):
...
def find_and_save_similar_movies():
    # delete all rows in the 'SimilarMovie' table
    SimilarMovie.objects.all().delete()
    all_movies = Movie.objects.all()

    for movie in all_movies:
        similar_movies = get_similar_movies_2(movie, all_movies)
        ...
        for similar_movie_dict in similar_movies:
            ...
            similar_mov.metagenre_similarity_percentage = similar_movie_dict[
