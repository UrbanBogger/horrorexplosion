...
def calculate_bonus_similarity_pts(similar_mov_list, movie):
    keywords_and_points = [
        ...
        ('found footage narrative', 3), ('giant monster(s)', 2),
        ('Graboid(s)', 3), ('H. P. Lovecraft related', 3),
        ('Jason Voorhees', 3), ('Jigsaw Killer', 3), ('Krampus', 3),
        ('Leatherface', 3), ('literary adaptation', 2), ('lovecraftian', 3),
        ...
        ('Richard B. Riddick', 3), ('Santa Claus', 2), ('Seduction Cinema', 3),
        ('shot on video (SOV)', 2), ('Splat Pack', 3),
