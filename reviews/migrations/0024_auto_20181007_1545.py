# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-10-07 14:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('reviews', '0023_auto_20181006_1949'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewed_tv_episode', models.ForeignKey(blank=True, help_text="Enter the TV episode that you're reviewing [OPTIONAL]", on_delete=django.db.models.deletion.CASCADE, to='reviews.TelevisionEpisode')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poster', models.ImageField(blank=True, help_text='Upload the poster of the movie', null=True, upload_to='images/')),
                ('poster_thumbnail', models.ImageField(blank=True, help_text='Upload the poster thumbnail', null=True, upload_to='images/')),
                ('movie_participation', models.ManyToManyField(blank=True, help_text='Add the name of the movie creator, their role and the position you want them to appear in the credits', to='reviews.MovieParticipation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tv_series_type', models.CharField(choices=[('Mini-Series', 'Mini-Series'), ('Anthology TV Series', 'Anthology TV Series'), ('Seasonal TV Series', 'Seasonal TV Series')], max_length=25)),
                ('first_created', models.DateField(auto_now_add=True, null=True)),
                ...
                ('alternative_title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tv_series_alternative_title_set', to='reviews.Title')),
                ('country_of_origin', models.ManyToManyField(help_text='Enter the country of origin', to='reviews.Country')),
                ('genre', models.ManyToManyField(help_text="Enter the motion picture's genre(s)", to='reviews.Genre')),
                ('keyword', models.ManyToManyField(help_text='Enter the keyword(s) that best describe the motion picture', to='reviews.Keyword')),
                ('main_title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tv_series_main_title_set', to='reviews.Title')),
                ('microgenre', models.ManyToManyField(blank=True, help_text="Enter the motion picture's microgenre [OPTIONAL]", to='reviews.Microgenre')),
                ('original_title', models.OneToOneField(blank=True, help_text="Enter the motion picture's original title [OPTIONAL]", null=True, on_delete=django.db.models.deletion.SET_NULL, to='reviews.Title')),
                ('subgenre', models.ManyToManyField(blank=True, help_text="Enter the motion picture's subgenre [OPTIONAL]", to='reviews.Subgenre')),
                ('tv_series_participation', models.ManyToManyField(blank=True, help_text='Add the name of the TV series creator, their role and the position you want them to appear in the credits', to='reviews.MovieParticipation')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text="Enter the season that you're reviewing [OPTIONAL]", on_delete=django.db.models.deletion.CASCADE, to='reviews.TelevisionSeason'),
        ),
        migrations.AddField(
            model_name='televisionreview',
            name='reviewed_tv_series',
            field=models.ForeignKey(help_text="Enter the TV series which you're reviewing", on_delete=django.db.models.deletion.CASCADE, to='reviews.TelevisionSeries'),
        ),
    ]
