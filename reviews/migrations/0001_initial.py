# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-06-23 18:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Enter the name of the genre', max_length=50)),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grade_numerical', models.CharField(choices=[('0.5', '0.5'), ('1.0', '1.0'), ('1.5', '1.5'), ('2.0', '2.0'), ('2.5', '2.5'), ('3.0', '3.0'), ('3.5', '3.5'), ('4.0', '4.0')], help_text="Choose the motion picture's grade", max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, default='', max_length=1000)),
                ('name', models.CharField(help_text='Enter the keyword (or a keyword phrase)', max_length=100, unique=True)),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('human_readable_url', models.SlugField(help_text="Enter the 'slug',i.e., the human-readable URL for the movie", null=True, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('human_readable_url', models.SlugField(help_text="Enter the 'slug',i.e., the human-readable URL for the movie review", null=True, unique=True)),
